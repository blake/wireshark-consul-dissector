...
local yamux_expert_info = {
    ...
    -- dissector helpful
    corrupted_frame = ProtoExpert.new("yamux.expert.debug.corrupted_frame", "Frame is corrupted", expert.group.DEBUG, expert.severity.WARN),
    undecoded_direction = ProtoExpert.new("yamux.expert.debug.undecoded_direction", "Cannot detect client-server direction. Addresses are equal", expert.group.DEBUG, expert.severity.NOTE),

    -- for user debugging
    client_packet = ProtoExpert.new("yamux.expert.packet_type.client", "Current packet is generated by client", expert.group.DEBUG, expert.severity.COMMENT),
    server_packet = ProtoExpert.new("yamux.expert.packet_type.server", "Current packet is generated by server", expert.group.DEBUG, expert.severity.COMMENT),
}
